...
#######################################################
pdffn = "Hominin Bayarealike tree21sgs.pdf"
...
#######################################################
# Plot legend for ALL states/ranges
#######################################################
...
states_to_put_in_legend = c(1,2,3,4,5,6,12,16,17,18,22,33)
...
#######################################################
#Get the probability of the ML state for each node 
#######################################################
relprobs_matrix = resBAYAREALIKE$ML_marginal_prob_each_state_at_branch_top_AT_node
